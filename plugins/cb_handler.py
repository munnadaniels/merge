...
async def cb_handler(c: Client, cb: CallbackQuery):
	...
	if cb.data == 'merge':
		...
		await cb.message.edit(
			text="Okay I'll upload to drive\nDo you want to rename? Default file name is **[@Trooporiginals]_merged.mkv**",
			reply_markup=InlineKeyboardMarkup(
				[
					[
		...
		await cb.message.edit(
			text='Do you want to rename? Default file name is **[@Trooporiginals]_merged.mkv**',
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton('👆 Default', callback_data='rename_NO'),
		...
		UPLOAD_AS_DOC.update({f'{cb.from_user.id}':False})
		await cb.message.edit(
			text=f"Do you want to rename? Default file name is **[@Trooporiginals]_merged.mkv**",
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton('👆 Default', callback_data='renameS_NO'),
		...
		if 'NO' in cb.data:
			await mergeSub(c,cb,new_file_name = f"./downloads/{str(cb.from_user.id)}/[@Trooporiginals]_merged.mkv")
